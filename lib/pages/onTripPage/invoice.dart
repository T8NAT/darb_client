                                                                                    ...
                                                                                    Column(
                                                                                      ...
                                                                                      children: [
                                                                                        Text(
                                                                                          ...
                                                                                          style: GoogleFonts.almarai(fontSize: media.width * fourteen, fontWeight: FontWeight.w600, color: textColor),
                                                                                        ),
                                                                                        Text(
                                                                                              ...
                                                                                              : (userRequestData['payment_type'].toString().split(',').toList()[i] == 'wallet')
                                                                                                  ...
                                                                                                  : (userRequestData['payment_type'].toString().split(',').toList()[i] == 'card')
                                                                                                      ...
                                                                                                      : (userRequestData['payment_type'].toString().split(',').toList()[i] == 'upi')
                                                                                                          ...
                                                                                                          : '',
                                                                                          style: GoogleFonts.almarai(fontSize: media.width * ten, color: textColor),
                                                                                        )
                                                                                      ],
                                                                                    ),
                                                                                    Expanded(
                                                                                      ...
                                                                                      children: [
                                                                                        Container(
                                                                                          height: media.width * 0.05,
                                                                                          width: media.width * 0.05,
                                                                                          decoration: BoxDecoration(shape: BoxShape.circle, color: white, border: Border.all(color: textColor, width: 1.2)),
                                                                                          alignment: Alignment.center,
