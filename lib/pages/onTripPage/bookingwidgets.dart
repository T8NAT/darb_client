                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      style: GoogleFonts.almarai(color: textColor),
                      onChanged: (val) {
                        setState(() {
                          promoCode = val;
                          couponerror = false;
                  ...
                  (isOutStation && widget.isOneWayTrip == false)
                    ...
                    children: [
                      ...
                      ['has_discount'] !=
                        ...
                        children: [
                          Text(
                            '${etaDetails[widget.showInfoInt]['total']
                                .toStringAsFixed(2)} ${etaDetails[widget
                                .showInfoInt]['currency']}'
                    ...
                    children: [
                                  ...
                                  (double.parse(yourAmount.text.toString()) -
                                      ...
                                      (double.parse(
                                          etaDetails[choosenVehicle]['total']
                                              .toString()) -
                                          ((double.parse(
                                              etaDetails[choosenVehicle]['bidding_low_percentage']
                                                  .toString()) /
                                              100) *
                                              double.parse(
                                                  etaDetails[choosenVehicle]['total']
                      ...
                      InkWell(
                                ...
                                (double.parse(yourAmount.text.toString()) +
                                    ...
                                    (double.parse(
                                        etaDetails[choosenVehicle]['total']
                                            .toString()) +
                                        ((double.parse(
                                            etaDetails[choosenVehicle]['bidding_high_percentage']
                                                .toString()) / 100) *
                                            double.parse(
                                                etaDetails[choosenVehicle]['total']
                                                    .toString())))) {
                        ...
                        child: Container(
                          ...
                          alignment: Alignment.center,
                          decoration: BoxDecoration(
                              color: (etaDetails[choosenVehicle]['bidding_high_percentage'] ==
                                  0 ||
                                  (double.parse(yourAmount.text.toString()) +
                                      ((userDetails['bidding_amount_increase_or_decrease']
                                          .toString()
                    ...
                    children: [
                      ...
                      (rentalOption[widget.showInfoInt]['has_discount'] !=
                        ...
                        children: [
                          ...
                          Text(
                            ' ${rentalOption[widget.showInfoInt]['fare_amount']
                                .toStringAsFixed(2)}',
                            style: GoogleFonts.almarai(
                                fontSize: media.width * fourteen,
                                color: textColor,
...
class _ChoosePaymentMethodContainerState
  ...
  String getLocalizedPaymentType(String paymentType) {
    // Map payment types to their language keys
    final paymentTypeKeys = {
      'cash': 'text_cash',
      'wallet': 'text_wallet',
      'card': 'text_card',
      'upi': 'text_upi'
    ...
    // Return localized text if available, otherwise return original payment type
    return languages[choosenLanguage][paymentTypeKeys[paymentType] ?? ''] ?? paymentType;
  }
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                flex: 6,
                                child: MyText(
                                  text: getLocalizedPaymentType(value.trim()),
                                  size: media.width * fourteen,
                                  color:
                                  // (choosenInPopUp == i)
              ...
              children: [
                ...
                FareBreakupDetails(
                    ...
                    value: (type != 1)
                        ...
                        : '${etaDetails[choosenVehicle]['currency']} ${rentalOption[choosenVehicle]['time_price_per_min']
                        .toString()} / min'),
                SizedBox(
                  height: width * 0.02,
                ),
                FareBreakupDetails(
                    ...
                    value: (type != 1)
                        ...
                        : '${etaDetails[choosenVehicle]['currency']} ${rentalOption[choosenVehicle]['distance_price_per_km']
                        .toString()} / ${rentalOption[choosenVehicle]['unit_in_words']}'),
                SizedBox(
                  height: width * 0.02,
                ),
                FareBreakupDetails(
...
class FareBreakupDetails extends StatelessWidget {
  ...
  const FareBreakupDetails({super.key,
    required this.width,
