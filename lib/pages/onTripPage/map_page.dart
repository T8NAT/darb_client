...
//navigate
  navigate() {
    ...
    print('navigatenavigatenavigatenavigatenavigate $choosenTransportType');
    isLoading = false;
...
// await location.requestService();
  ...
  Widget _buildWithoutDisButton() {
    final media = MediaQuery.of(context).size;

    return CupertinoButton(
      padding: const EdgeInsets.all(0), // Remove default padding
      onPressed: () {
        print('BookingConfirmationBookingConfirmation ppppp kfgkkdfgfd   $choosenTransportType');
        ismulitipleride = false;
        setState(() {
          Navigator.pushAndRemoveUntil(
              context,
      ...
      child: Container(
        width: media.width * 0.9, // Set width to 90% of screen width
        decoration: BoxDecoration(
          color: isDarkTheme ? buttonColor : secondaryAppColor, // Background color
          borderRadius: BorderRadius.circular(media.width * 0.02), // Rounded corners
        ),
        child: Container(
          height: media.width * 0.12, // Set height
          ...
          child: Row(
            ...
            children: [
              ...
              FittedBox(
                fit: BoxFit.contain,
                child: Text(
                  languages[choosenLanguage]['text_ridewithout_destination'], // Button text
                  style: GoogleFonts.almarai(
                    fontSize: media.width * 0.04, // Font size
...
// ignore: prefer_typing_uninitialized_variables
  ...
  Widget build(BuildContext context) {
    print('maaaaaaaaaappagemaaaaaaaaaappage');
                                                              ...
                                                              return GoogleMap(
                                                                ...
                                                                if (addressList.isEmpty) {
                                                                  ...
                                                                  setState(() {
                                                                    ...
                                                                    isLocationVisible = true; // Set to true when camera moves
                                                                  });
                                                                }
                                                              },
                                                                onCameraIdle:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Expanded(
                                                                              ...
                                                                              child: Text(
                                                                                userDetails['contact_us_mobile1'],
                                                                                style: GoogleFonts.almarai(fontSize: media.width * fourteen, color: textColor),
                                                                              ))
                                                                        ],
                                                                      ),
                                                                    ),
                                                                      ...
                                                                      children: [
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Row(
                                                                                  children: [
                                                                                    GestureDetector(
                                                                                      onTap: () {
                                                                                        // Handle back icon click - Navigate to drop location
                                                                                        setState(() {
                                                                                          _pickaddress = false;
                                                                                          _dropaddress = true;
                                                                                          addAutoFill.clear();
                                                                                    ...
                                                                                    if (isLocationVisible)
                                                                                      GestureDetector(
                                                                                        onTap: () {
                                                                                          // Only clear the text, don't navigate
                                                                                          setState(() {
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child: Align(
                                                                            ...
                                                                            child: Text(languages[choosenLanguage]['text_best_events'], style: GoogleFonts.almarai(
                                                                                color: eventsTxTColor,
                                                                                        ...
                                                                                        children: [
                                                                                          Column(
                                                                                            children: [
                                                                                              InkWell(
                                                                                                onTap: () {
                                                                                                  print('onTapchoosenTransportType ppppp kfgkkdfgfd   $choosenTransportType');
                                                                                                          ...
                                                                                                          child: Stack(
                                                                                                            children: [
                                                                                                              ...
                                                                                                              Container(
                                                                                                                ...
                                                                                                                //       width: (choosenTransportType == 2) ? 2 : 0),
                                                                            ...
                                                                            children: [
                                                                                                                        ...
                                                                                                                        Expanded(
                                                                                                                          child: SizedBox(
                                                                                                                            ...
                                                                                                                            child: TextField(
                                                                                                                                ...
                                                                                                                                style: GoogleFonts.almarai(fontSize: media.width * fourteen, color: (isDarkTheme == true) ? Colors.white : textColor),
                                                                                                                                onSubmitted: (value) {
                                                                                                                                  setState(() {
                                                                                                                                    _pickaddress = false;
                                                                                                                                  });
                                                                                        ...
                                                                                        SizedBox(
                                                                                          ...
                                                                                          child: Row(
                                                                                            ...
                                                                                            children: [
                                                                                              InkWell(
                                                                                                onTap: () {
                                                                                                  print('BfffffookingConfirmationBookingConfirmation ppppp kfgkkdfgfd   $choosenTransportType');
                                                                                                  ismulitipleride = false;
                                                                              ...
                                                                              (recentSearchesList.isNotEmpty)
                                                                                  ? Column(
                                                                                      ...
                                                                                      children: [
                                                                                        Padding(
                                                                                          padding: EdgeInsets.only(left: media.width * 0.03, right: media.width * 0.03, top: media.width * 0.03, bottom: media.width * 0.02),
                                                                                          child: MyText(
                                                                                        ...
                                                                                        for (var i = recentSearchesList.length - 1; i >= 0; i--)
                                                                                          Column(
                                                                                            children: [
                                                                                              ...
                                                                                              Divider(color: secondaryAppColor),
                                                                                              SizedBox(
                                                                                                height: media.width * 0.03,
                                                                                              ),
                                                                                            ],
                                                                                                                ...
                                                                                                                return MapEntry(
                                                                                                                    ...
                                                                                                                    (i < 5)
                                                                                                                        ? Material(
                                                                                                                            ...
                                                                                                                            child: InkWell(
                                                                                                                              onTap: () async {
                                                                                                                                print('dfdgfdg ppppp kfgkkdfgfd   $choosenTransportType');
                                                                                                                                if (_pickaddress == true) {
                                                                                                                                  setState(() {
                                                                                                                                    addAutoFill.clear();
                                                                                                                                    if (addressList.where((element) => element.type == 'pickup').isEmpty) {
                                                                                                                              ...
                                                                                                                              child: Container(
                                                                                                                                ...
                                                                                                                                // decoration: BoxDecoration(color: hintColor.withOpacity(0.1), borderRadius: BorderRadius.circular(media.width * 0.02)),
                                                                                                                                child: Row(
                                                                                                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                                                                                  children: [
                                                                                                                                    Container(
                                                                                                                                      ...
                                                                                                                                      child: (favAddress[i]['address_name'] == 'Home')
                                                                                                                                          ...
                                                                                                                                          : (favAddress[i]['address_name'] == 'Work')
                                                                                                                                              ...
                                                                                                                                              : Padding(
                                                                                                                                                padding: const EdgeInsets.only(right: 3.0, top: 2),
                                                                                                                                                child: Image.asset(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        print(
                                            'choosenTransportType kfgkkdfgfd   $choosenTransportType');
                                        if (choosenTransportType == 3) {
                                    ...
                                    InkWell(
                                      onTap: () {
                                        print(
                                            'choosenTransportType ppppp kfgkkdfgfd   $choosenTransportType');
                                        if (choosenTransportType == 3) {
                                          if (addressList.isNotEmpty) {
                                            choosenTransportType = 1;
                                            ismulitipleride = false;
