...
//pick image from camera
                        ...
                        child: Column(
                          children: [
                              ...
                              child: ClipPath(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                      border:
                                          Border.all(color: primaryAppColor, width: 0),
                            ...
                            AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                  color: primaryAppColor,
                                  border: Border.all(color: primaryAppColor, width: 0)),
                              child: SingleChildScrollView(
                                ...
                                child: Column(
                                  children: [
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration: InputDecoration(
                                                                              ...
                                                                              hintStyle: GoogleFonts.almarai(fontSize: media.width * sixteen, color: hintColor)),
                                                                          style: GoogleFonts.almarai(
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(width: media.width * 0.05), // Add some spacing between the two texts
                                            Expanded(
                                              child: InkWell(
                                                onTap: () {
                                                  _error = '';
                                                ...
                                                child: MyText(
                                                  text: (forgotPassword == true)
                                                      ...
                                                      : withOtp? null : languages[choosenLanguage]['text_forgot_password'],
                                                  size: media.width * ten,
                                          ...
                                          if (newPassword == true) {
                                                ...
                                                if (
                                                  ...
                                                  if (phoneAuthCheck == true) {
                                                    if (isLoginemail == true) {
                                                      ...
                                                      print('_email_email ${_email.text}');
                                                  ...
                                                  print('_error_error_error_error_error_error ${_email.text}');
                                                  setState(() {
                                                    if (_password
                                                        .text.isEmpty) {
                                                      _error = languages[
                                            ...
                                            if (mobileVerified == true) {
                                              ...
                                              if (_name.text.isNotEmpty &&
                                                ...
                                                RegExp regExp = RegExp(pattern);
                                                print(
                                                    'countries[phcode] ${countries[phcode]}');
                                                print(
                                                    '_mobile.text ${_mobile.text}');
                                                print(
                                                    '_mobile.text ${regExp.hasMatch(_mobile.text)}');
                                    ...
                                    if (forgotPassword == true && !withOtp)
                                      SizedBox(
                                        width: media.width * 0.5,
                                        child: TextButton(
                                            onPressed: () {
  ...
  Widget _buildGoogleSignInButton() {
    ...
    return CupertinoButton(
      ...
      onPressed: () => _handleGoogleSignIn(context), // Handle Google sign-in
      child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              FittedBox(
                fit: BoxFit.contain,
                child: Text(
                  languages[choosenLanguage]?['signInWithGoogle'] ?? 'Sign in with Google', // Button text
                  style: GoogleFonts.almarai(
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Image.asset(
                'assets/images/apple.png', // Google icon
                height: 24, // Icon height
              ),
              const SizedBox(width: 10), // Spacing between icon and text
              FittedBox(
                fit: BoxFit.contain,
                child: Text(
                  languages[choosenLanguage]?['signInWithApple'] ?? 'Sign in with Apple', // Button text
                  style: GoogleFonts.almarai(
                    fontSize: media.width * 0.04, // Font size
                    color: Colors.white, // Text color
                    fontWeight: FontWeight.bold, // Font weight
  ...
  Future<void> _handleGoogleSignIn(context) async {
    ...
    try {
     ...
     final res=  await userSocialLogin(context,googleAuth!.accessToken, 'google');
     print('resresresresresresresresres $res');
      navigate(res);
  ...
  Future<void> _handleAppleSignIn(context) async {
    try {
      ...
      setState(() => loginLoading = true);
      print('credential.identityTokencredential.identityToken\n ${credential.identityToken}');
      final res = await userSocialLogin(context,credential.identityToken, 'apple');
      navigate(res);
      setState(() => loginLoading = false);
