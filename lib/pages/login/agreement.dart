            ...
            Container(
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      ...
                      colors: [primaryAppColor.withOpacity(0.5), backgroundColor])),
              child: Column(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: MyText(
                            text: languages['ar']['text_welcome_to']
                                .toString()
                                .replaceAll('5555', 'درب'),
                    ...
                    child: Button(
                        ...
                        onTap: () async {
                          if (ischeck == true) {
                            ...
                            setState(() {
                              _error = languages[choosenLanguage]['Please tick the checkbox above'];
                            });
                          }
                        },
