...
class _FavAddressPageState extends State<FavAddressPage> {
  ...
  Future<void> getFavLocations() async {
    ...
    for (var e in favAddress) {
      if (e["address_name"] == languages[choosenLanguage]['text_work']) {
        work.add(e);
      } else if ( e["address_name"] == languages[choosenLanguage]['text_home']) {
        home.add(e);
      } else {
        others.add(e);
      }
                                        ...
                                        Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                    builder: (context) =>
                                                        DropLocation(
                                                            from: 'favourite',
                                                            favName: languages[choosenLanguage]['text_home'])))
                                            .then((_) async {
                                          await getFavLocations();
                                        });
                                      },
                                                          ...
                                                          builder: (context) =>
                                                              DropLocation(
                                                                  from:
                                                                      'favourite',
                                                                  favName:
                                                                  languages[choosenLanguage]['text_home']))).then(
                                                      (_) async {
                                                    await getFavLocations();
                                                  });
                                                },
                                        ...
                                        Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                    builder: (context) =>
                                                        DropLocation(
                                                            from: 'favourite',
                                                            favName: languages[choosenLanguage]['text_work'])))
                                            .then((_) async {
                                          await getFavLocations();
                                        });
                                      },
                                                          ...
                                                          builder: (context) =>
                                                              DropLocation(
                                                                  from:
                                                                      'favourite',
                                                                  favName:
                                                                      languages[choosenLanguage]['text_work']))).then(
                                                      (_) async {
                                                    await getFavLocations();
                                                  });
                                                },
...
// REMOVE DIALOGE
  AlertDialog deleteDialoge(BuildContext context, int index, List addressList) {
    ...
    return AlertDialog(
      ...
      backgroundColor:
          (isDarkTheme == true) ? borderLines.withOpacity(0.5) : white,
      title: Row(
