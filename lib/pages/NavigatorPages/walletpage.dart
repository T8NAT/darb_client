...
class _MonetTransferBottomSheetState extends State<MonetTransferBottomSheet> {
  List<DropdownMenuItem<String>> get dropdownItems {
    List<DropdownMenuItem<String>> menuItems = [
      DropdownMenuItem(value: "user", child: Text(languages[choosenLanguage]['text_user'])),
      DropdownMenuItem(value: "driver", child: Text(languages[choosenLanguage]['text_driver'])),
    ];
    return menuItems;
  }
