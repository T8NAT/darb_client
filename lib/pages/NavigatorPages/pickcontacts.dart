                  ...
                  Expanded(
                    child: (contacts.isNotEmpty)
                      ...
                      child: Column(
                        ...
                        children: contacts.where((contact) =>
                        !sosData
                            .map((e) => e['number'])
                            .toString()
                            .replaceAll(' ', '')
                            .contains(contact['phone'].toString().replaceAll(' ', ''))
                        ).map((contact) =>
                            Container(
                              ...
                              child: InkWell(
                                onTap: () {
                                  setState(() {
                                    pickedName = contact['name'];
                                    pickedNumber = contact['phone'];
                                  });
                                },
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
