...
Future<void> initMessaging() async {
  ...
  FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
    print(
        'messagemessagemessagemessagemessagemessagemessagemessage ${message.toMap()}');
    ...
    if (notification != null) {
      if (message.data['push_type'].toString() == 'general') {
        ...
        if (message.data['image'].isNotEmpty) {
          print('_showBigPictureNotificationURLGeneral');
          _showBigPictureNotificationURLGeneral(message.data);
        } else {
          print('_showGeneralNotification');
          _showGeneralNotification(message.data);
        }
      } else {
        print('showRideNotification');
