...
Color appBackground = const Color(0xff093560);
...
Color buttonColor = const Color(0xff48c3c8);
Color secondaryAppColor = const Color(0xfff2a962);
Color primaryAppColor = const Color(0xff48c3c8);
...
Color loaderColor = const Color(0xff48c3c8);
...
Color back = const Color(0xffC8C7CC);
// Color pickColor = const Color(0xff309700);
